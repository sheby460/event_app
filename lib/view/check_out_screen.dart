...
String eventImage = '';
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  myText(
                    text: '\TZS${widget.eventDoc!.get('price')}',
                    style: const TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  myText(
                    text: 'TZS${int.parse(widget.eventDoc!.get('price')) + 2}',
                    style: TextStyle(
                      fontSize: 16,
                      color: AppColors.blue,
                      fontWeight: FontWeight.w600,
  ...
  void makePayment(BuildContext context, {required String amount, required String eventId}) {}
}